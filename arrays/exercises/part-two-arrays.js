...
// Add the items 1138 and ‘20 meters’ to the the array - the number at the 
// start and the string at the end. Print the updated array to confirm the changes.
cargoHold.unshift(1138);
cargoHold.push('20 meters');
console.log(cargoHold)
// 5) Use a template literal to print the final array and its length.
console.log(`The final array is as follows: [${cargoHold}] it has a length of ${cargoHold.length} items.`);
