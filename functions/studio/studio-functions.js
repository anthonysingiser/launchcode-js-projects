...
function pushReversedArray(arr) {
    for (x in arr){
        reversedArray.push(reverseCharacters(arr[x]));
    }
    return;
}

pushReversedArray(arrayTest1);
pushReversedArray(arrayTest2);
pushReversedArray(arrayTest3);
